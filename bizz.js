...
(function(window) {
  ...
  function define_Bizz() {
    ...
    function _bizDaysBetween(startDate, endDate, holidays) {
      var daysCount = 0,
          removeHolidays,
          i;

      for(i = new Date(startDate); i <= endDate; i.setDate(i.getDate() + 1)) {
        if (i.getUTCDay() != 6 && i.getUTCDay() != 0) {
